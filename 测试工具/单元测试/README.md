...
在`split`包路径下，执行go test命令，可以看到输出结果如下：
...
上面的命令会将覆盖率相关的信息输出到当前文件夹下面的`c.out`文件中，然后我们执行`go tool cover -html=c.ou`t，使用`cover`工具来处理生成的记录信息，该命令会打开本地的浏览器窗口生成一个HTML报告。

![20191228152235.png](https://raw.githubusercontent.com/HanShoujun/picBed/master/imgs/20191228152235.png)
...
![20191228163742.png](https://raw.githubusercontent.com/HanShoujun/picBed/master/imgs/20191228163742.png)
