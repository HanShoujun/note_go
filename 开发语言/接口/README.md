...
一个接口的值（简称接口值）是由`一个具体类型`和`具体类型的值`两部分组成的。这两部分分别称为接口的动态类型和动态值。
...
![20191227141626.png](https://raw.githubusercontent.com/HanShoujun/picBed/master/imgs/20191227141626.png)
